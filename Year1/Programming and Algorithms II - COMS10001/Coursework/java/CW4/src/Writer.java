...
public class Writer {
	 ...
	 * 
	 * @param filename
	 *            The name of the file that the graph will be saved to
	 * @throws IOException
	 */
	...
	/**
	 * Static write function that allows you to save a graph without having to
	 * instantiate the Writer object. Saves a bit of coding
	 * 
	 * @param filename
	 *            The name of the file that the graph will be writen to
	 * @param g
	 *            The graph that will be writen
	 * @throws IOException
	 */
